              ...
              <div class="d-flex">
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                    ...
                    <a class="dropdown-item" href="#">Nombres, A hasta la Z</a>
                    <a class="dropdown-item" href="#">Nombres, A hasta la Z</a>
        ...
        <div class="col-md-3 order-1 mb-5 mb-md-0">
          <div class="border p-4 rounded mb-4">
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-1"><a href="#" class="d-flex"><span>Cuadernos</span> <span class="text-black ml-auto">(620)</span></a></li>
              <li class="mb-1"><a href="#" class="d-flex"><span>Lapiceros</span> <span class="text-black ml-auto">(450)</span></a></li>
              <li class="mb-1"><a href="#" class="d-flex"><span>Tijeras</span> <span class="text-black ml-auto">(124)</span></a></li>
              <li class="mb-1"><a href="#" class="d-flex"><span>Temperas</span> <span class="text-black ml-auto">(424)</span></a></li>
              <li class="mb-1"><a href="#" class="d-flex"><span>Borradores</span> <span class="text-black ml-auto">(124)</span></a></li>
              <li class="mb-1"><a href="#" class="d-flex"><span>Lápices</span> <span class="text-black ml-auto">(200)</span></a></li>
              <li class="mb-1"><a href="#" class="d-flex"><span>Plumones</span> <span class="text-black ml-auto">(282)</span></a></li>
            </ul>
          </div>
        </div>
      </div>
