 ...
 * durante el proceso de recuperación de contraseña. Este servlet compara el OTP proporcionado 
 * por el usuario con el valor almacenado en la sesión. Si los códigos coinciden, redirige al 
 * usuario a la página para establecer una nueva contraseña; si no coinciden, redirige de nuevo 
 * a la página para ingresar el OTP con un mensaje de error.
 * 
 * @author Team Shalom
 * @version 1.5
 */
...
public class ValidateOtp extends HttpServlet {
     ...
     * Este método obtiene el OTP proporcionado por el usuario y lo compara con el valor almacenado
     * en la sesión. En función del resultado, redirige al usuario a la página correspondiente.
     * 
     * @param request la solicitud HTTP que contiene el OTP ingresado por el usuario y otros parámetros.
     * @param response la respuesta HTTP que se envía al usuario, redirigiéndolo a la página adecuada.
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Declaración de RequestDispatcher para la redirección a las páginas correspondientes.
        RequestDispatcher dispatcher = null;

        // Comparar el OTP ingresado con el almacenado en la sesión.
        if (value == otp) {
            // Si el OTP es correcto, se envían los parámetros a la siguiente página.
            ...
            // Si el OTP es incorrecto, se establece un mensaje de error y se redirige de nuevo al formulario de OTP.
            request.setAttribute("message", "wrong otp");

            // Redirigir a la página para ingresar nuevamente el OTP.
